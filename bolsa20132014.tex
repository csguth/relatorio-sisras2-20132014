...
As interconexões mais complexas devem ser representadas levando em consideração suas características resistivas e capacitivas. Essas então, são modeladas como árvores RC (\autoref{fig:rc}), que conforme \citeonline{Rabaey08}, têm as seguintes características: 
...
\legend{Adaptada de \cite{Contest2013}.}
\end{figure}
